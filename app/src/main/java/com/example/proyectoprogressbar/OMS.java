...
public class OMS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WebView webView = findViewById(R.id.OMS_agua);
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
                ...
                Toast.makeText(OMS.this, "Error al cargar la página web: " + description, Toast.LENGTH_SHORT).show();
            }
        });

        // Cargar la URL deseada en el WebView
        webView.loadUrl("https://www.who.int/es/news-room/fact-sheets/detail/drinking-water");
    }
}
